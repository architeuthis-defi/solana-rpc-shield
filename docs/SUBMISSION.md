...
| 90%+ coverage via network drop & latency simulations | **98.2% lines / 92.8% branches / 100% functions**, thresholds enforced in CI; simulations are real HTTP servers (drops, hangs, 5xx, latency) **plus cross-node consistency divergence** |
